...
<nav class="navbar navbar-inverse navbar-fixed-top">
  <div class="container">
	...
	<div id="navbar" class="navbar-collapse collapse">
							<ul class="nav navbar-nav">
								<li class="dropdown">
									<a href="#" class= "btn btn-secondary"' class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Adicionar <span class="caret"></span></a>
												...
												<li><a href="cad_usuario_aluno.php">Aluno</button></a>
												<li><a href="cad_usuario_visitante.php">Visitante</button></a>
												<li><a href="cad_classe.php">Classe</button></a>
												<li><a href="cad_apontamento.php">Apontamento</button></a>
												<li><a href="cad_pontuacao.php">Pontuação</button></a>

											<!--	<li><a href="cad_aluno-classe.php">Aluno > Classe</button></a>-->
						...
						<ul class="nav navbar-nav">
								<li class="dropdown">
									<a href="#" class= "btn btn-secondary"' class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Listar <span class="caret"></span></a>
												...
												<li><a href="listar_classe.php">Classes</button></a>
				...
				<!--		<ul class="nav navbar-nav">
								<li class="dropdown">
									<a href="#" class= "btn btn-secondary"' class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Editar <span class="caret"></span></a>
												<ul class="dropdown-menu">
												<li><a href="editar_aluno.php">Aluno</button></a>
												<li><a href="editar_visitante.php">Visitante</button></a>
												<li><a href="editar_classe.php">Classe</button></a>		
